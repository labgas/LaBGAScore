...
% PET-specific adaptations have already been made
%
% -------------------------------------------------------------------------
%
...
keyword_sigs = {'nps','siips','pines','multisensory','fmpain'};                                    % default 'all'                     cell array of signature images and/or keywords passed into load_image_set, help load_image_set for overview of many options
