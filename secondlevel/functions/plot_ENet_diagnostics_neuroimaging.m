...
% plot_ENet_diagnostics_neuroimaging  Plotting and diagnostics for Elastic Net neuroimaging pipelines.
%
...
if numel(roiNames) ~= p
    error('plot_ENet_diagnostics_neuroimaging:roiNamesLength', ...
...
validateAtlasLabels(atlasData, p, 'plot_ENet_diagnostics_neuroimaging');
