%% LaBGAScore_mrs_run_osprey_GE.m
%
%
% *USAGE*
%
...
% (LaBGAScore_mrs_osprey_jobfile_GE.m or, if nr_sess = 1,
% LaBGAScore_mrs_osprey_single_sess_jobfile_GE.m, renamed per study to
% [study_prefix]_mrs_s0_osprey_jobfile_[voxel]_GE.m).
%
...
% -------------------------------------------------------------------------
%
% LaBGAScore_mrs_run_osprey_GE.m                        v1.10
%
